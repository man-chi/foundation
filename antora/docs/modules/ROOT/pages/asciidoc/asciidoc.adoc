...
== This is the priority formula rendered by MathJax:
++++
  <script>
  MathJax = {
    tex: {inlineMath: [['$', '$'], ['\\(', '\\)']]}
...
== antora image preview in vscode
* vscode-asciidoc extension > settings > 
* asciidoc >preview : asciidoctor attributes¬¬
